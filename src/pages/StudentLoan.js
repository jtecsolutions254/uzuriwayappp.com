...
const StudentLoan = () => {
  ...
  return (
    <div className="student-loan">
      <h2>School fees Loan Application Requirements</h2>
      <p>To apply for a school fees loan, you must meet the following eligibility criteria:</p>
      <ul>
      ...
      <button onClick={handleFormToggle}>
        {showForm ? 'Hide Application Form' : 'Apply for students Loan'}
      </button>
